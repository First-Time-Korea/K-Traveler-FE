...
const tryGetArticle = () => {
  getArticle(
    ...
    (error) => {
      console.log(error);
      alert("Failed to get travel reviews.");
    }
  );
};
  ...
  deleteArticle(
    ...
    (response) => {
      if (response.status == 200) {
        alert("You have finished deleting your travel reviews.");
      }
      ...
      <div class="flex flex-row p-2 h-full">
          ...
          <div class="text-right mt-4">
            ...
            <div class="flex justify-end mt-4" v-if="isShowedModifyButtons">
              ...
              <button
                ...
                type="button" @click="tryDeleteArticle">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
        ...
        <div class="flex-1 m-4 flex flex-col justify-between h-[98%]">
          ...
          <div class="ml-4 mr-2 mt-2">
            <div class="flex flex-row mb-2 hover:cursor-pointer" v-show="isShowedParentComment"
