...
<template>
  <div class="mb-20 container text-center">
    <h5
      class="text-blue-gray-700 block mb-3  text-2xl antialiased font-semibold leading-snug tracking-normal text-inherit">
      {{ question.text }}
    </h5>
    <div class="flex justify-center">
      <h6
        class="agree-text mr-8 inline-flex items-center block  text-base antialiased font-semibold leading-relaxed tracking-normal text-inherit">
        Agree
      </h6>
      ...
      <h6
        class="text-third-400 ml-8 inline-flex items-center block  text-base antialiased font-semibold leading-relaxed tracking-normal text-inherit">
        Disagree
      </h6>
    </div>
  </div>
