  ...
  <div class="flex justify-center mt-20">
    <div class="relative flex flex-col text-gray-700 bg-white shadow-md rounded-xl p-10">
      ...
      <form class="max-w-screen-lg w-80 sm:w-96">
        ...
        <!-- 회원가입 버튼 -->
        <button
          class="mt-6 block w-full select-none rounded-lg bg-white-500 py-3 px-6 text-center align-middle font-sans text-xs font-bold uppercase text-white shadow-md shadow-gray-900/10 transition-all hover:shadow-lg hover:shadow-gray-900/20 focus:opacity-[0.85] focus:shadow-none active:opacity-[0.85] active:shadow-none disabled:pointer-events-none disabled:opacity-50 disabled:shadow-none"
