    ...
    <div class="flex justify-center mt-20">
        <div class="relative flex flex-col text-gray-700 bg-white shadow-md rounded-xl p-10">
            ...
            <form class="max-w-screen-lg w-80 sm:w-96" @submit.prevent="goSignUp">
                ...
                <button
                    class="mt-6 block w-full select-none rounded-lg py-3 px-6 text-center align-middle text-xs font-bold uppercase text-white shadow-md transition-all focus:opacity-[0.85] focus:shadow-none active:opacity-[0.85] active:shadow-none disabled:pointer-events-none"
