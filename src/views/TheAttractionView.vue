<script setup>
// import VMap from '@/components/attraction/VMap.vue';
// import VSelect from '@/components/common/VSelect.vue';
import { onMounted, ref } from "vue";
import { getTheme, getCategory, getSearch } from "@/api/attraction.js";
...
const searchAttraction = () => getSearch(searchItem,
    ({ data }) => {
        ...
        <div class="row justify-content-center">
            <div class="col-8 d-flex justify-content-center align-items-center">
                ...
                <div class="mr-2 flex-grow-1">
                    <select v-model="themeList.themeCode" @change="selectTheme($event.target.value)"
                ...
                <!-- Category Select Box -->
                <div class="mr-2 flex-grow-1">
                    <select v-model="categoryList.categoryCode" @change="selectCategory($event.target.value)"
                        class="peer h-full w-full rounded-[7px] border border-blue-gray-200 border-t-transparent bg-transparent px-3 py-2.5 font-sans text-sm font-normal text-blue-gray-700 outline outline-0 transition-all placeholder-shown:border placeholder-shown:border-blue-gray-200 placeholder-shown:border-t-blue-gray-200 empty:!bg-gray-900 focus:border-2 focus:border-gray-900 focus:border-t-transparent focus:outline-0 disabled:border-0 disabled:bg-blue-gray-50">
                ...
                <button
                    ...
                    type="button" @click="searchAttraction">
